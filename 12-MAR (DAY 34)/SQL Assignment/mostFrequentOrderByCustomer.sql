...
CREATE TABLE orders2 (order_id INT PRIMARY KEY, order_date DATE, customer_id INT, product_id INT);
CREATE TABLE products2 (product_id INT PRIMARY KEY, product_name VARCHAR(20), price INT);
...
SELECT customer_id, COUNT(*) AS Order_count FROM orders2
